...
class Adapter:
    ...
    def __init__(self, input):
        ...
        self.url = 'https://api.stlouisfed.org/fred/series/observations?file_type=json&limit=1&offset=0&sort_order=desc&units=lin'
    ...
    def create_request(self):
        try:
            ...
            data = response.json()
            self.result = data['observations'][0]['value']
